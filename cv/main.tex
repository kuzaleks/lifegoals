...
\cventry{2009--present}{TA at Belarusian State University}{Department of Informatics and Computer Systems}{Minsk}{}{Teaching programming and numerical methods \\ Scientific research, programming, English language support}
...
\cvdoubleitem{Python}{Numpy, Scipy, sklearn}{Scala}{rx observable, akka}
\cvdoubleitem{C++}{teaching at BSU}{Linux}{Ubuntu Linux}
\cvdoubleitem{Subversion}{git}{Octave}{Machine Learning}
\cvdoubleitem{DB}{basics of PostgreSQL, MongoDB}{IDE}{emacs, Eclipse}
%\cvdoubleitem{Objective-C}{iOS}{IDE}{emacs, Eclipse}
%\cvdoubleitem{IAAS}{AWS}{PAAS}{basics of Heroku}
...
\cvitem{Coursera}{Linear and Descrete Optimization}
...
\cvitem{2013--present}{IEEE Membership}
\cvitem{2013--present}{IEEE Signal Processing Society Membership}
\cvitem{2013--present}{IEEE Computer Society Membership}
%\section{Extra 1}
%\cvlistitem{Item 1}
%\cvlistitem{Item 2}
