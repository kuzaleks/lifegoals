...
* OOP Design as an approximation of Descrite reality modeling using Finate Automata
  ...
  descrete systems by Finate Automata. May be the idea behind OOP design is create informal 
  approximation of finate automatas for reality modeling. Each object persist state and
  states (State) are changed by calling the appropriate methods (Action or Event)
